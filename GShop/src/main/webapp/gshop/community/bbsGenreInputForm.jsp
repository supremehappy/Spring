...
<form:form modelAttribute="bbsGenre" action="../community/write.html" method="post" enctype="multipart/form-data" onSubmit="return validate(this)">
	...
	<form:hidden path="view_order" value="${ bbsGenre.view_order + 1}"/>
	<table border="1" width="100%">
		...
		<tr>
			<td>닉네임</td>
			<td><form:input path="nickname" value="${ NICKNAME }" disabled="true"/>
			</td>
		</tr>
		<tr>
			<td>이미지1</td>
